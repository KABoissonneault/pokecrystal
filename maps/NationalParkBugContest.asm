...
NationalParkBugContest_MapEvents:
	...
	def_object_events
; BUG FIX: Some trainer NPCs have inconsistent overworld sprites
; Cannot fix the Youngsters to Bug Catchers, the sprite is not available for the National Park
